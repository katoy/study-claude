...
- 件名（必須、最大255文字）
- 本文（必須、最大2000文字）
- 全入力項目に Alpine.js によるリアルタイム文字数カウンターを表示。各項目の最大文字数を超えると、カウンターおよび入力欄の枠線・文字色を赤色で警告表示
...
- 余白・パディング・本文クランプ行数を最適化し、1画面内に最大件数のお問い合わせをスッキリ収める高密度設計
...
- 絞り込みエリアの折りたたみ・展開（開閉状態の永続化、折りたたみ時の適用中条件バッジ表示）
