<div class="py-3">
    <div class="mb-3 flex flex-wrap items-center justify-between gap-2.5">
        ...
        <div>
            <a href="{{ route('admin.contacts.export', $exportQuery ?? []) }}" class="min-h-11 inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg shadow-sm active:scale-95 transition-all text-xs sm:text-sm" aria-label="{{ __('CSVエクスポート') }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                </svg>
                <span>{{ __('CSVエクスポート') }}</span>
            </a>
        </div>
    </div>
